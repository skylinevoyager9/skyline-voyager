/** Customer-facing pricing copy (aligned with agency / OTA norms). */
...
export const PRICE_UPDATED_MESSAGE =
  "This fare changed since you searched. The total below is the current price from the airline.";
